import burgar from "../assets/images/others/burgar.png"
import marketExperience from "../assets/images/others/Market Place.png"
const About = () => {
    return (
        <div className="w-full md:h-[864px] h-[1144.03px] max-w-[1373.5px] mx-auto px-4 sm:px-6 lg:px-8 xxl:px-[300px]">
            <div className="md:flex md:mt-[120px] mt-8 mb-8 md:mb-[74px]">
                <div className="relative">
                    <img className="w-[617px] h-[480px]" src={burgar} alt="" />
                    <img className="absolute top-[30.25px] w-[241.17px]" src={marketExperience} alt="" />
                </div>
                <div className="md:ms-[79px] md:w-[624px] w-[330px] h-[402px] text-xl">
                    <div>
                        <ul className="flex text-[14px] mb-8 border-b-2 border-[#BD1F17]">
                            <li className="px-4 py-[6px] hover:bg-[#BD1F17] hover:text-white">About</li>
                            <li className="ms-4 px-4 py-[6px] hover:bg-[#BD1F17] hover:text-white">Experience</li>
                            <li className="ms-4 px-4 py-[6px] hover:bg-[#BD1F17] hover:text-white">Contact</li>
                        </ul>
                        ...
                        <div className="flex h-12 md:h-[56px] md:mt-[32px] mt-28">
                            <button className="md:w-[161px] w-[149px] bg-[#FEBF00] text-[18px] font-bold">ABOUT MORE</button>
                            <div className="flex md:ms-8 ms-4">
                                <svg className="w-5 h-5 my-4 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className="md:text-[18px] text-[14px] font-bold ms-2 mt-3">+88 3426 739 485</p>
                            </div>
                        </div>
                    </div>
                </div>
