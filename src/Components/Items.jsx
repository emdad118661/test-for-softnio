        ...
        <div className="w-full md:h-[710px] h-[552px] bg-[#FBF7F2]">
            <div className="md:max-w-[1320px] max-w-[330px] mx-auto px-4 sm:px-6 lg:px-8 xxl:px-[300px]">
                <div className="md:pt-[120px] pt-[32px] md:flex">
                    ...
                    <div onClick={rightToLeft} className="absolute md:top-[2031px] top-[2695px] left-[180px] md:left-[1168px] rounded-full bg-white shadow-2xl w-[60px] h-[60px]">
                    ...
                    <div onClick={leftToRight} className="absolute md:top-[2031px] top-[2695px] md:left-[1260px] left-[261.33px] rounded-full shadow-2xl bg-white w-[60px] h-[60px]">
                        <svg className="mt-5 ms-6" width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
