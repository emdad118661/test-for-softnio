    ...
    return (
        <div className="w-full md:h-[710px] h-[552px] bg-[#FBF7F2]">
            <div className="md:max-w-[1373.5px] max-w-[330px] mx-auto px-4 sm:px-6 lg:px-8 xxl:px-[300px]">
                <div className="md:pt-[120px] md:flex">
                    <div className="md:w-[1168px]">
                        <li className="text-[20px] h-[32px] list-square text-[#BD1F17] font-bold">Crispy, Every Bite Taste</li>
                        <h1 className="text-4xl h-[62px] font-bold">POPULAR FOOD ITEMS</h1>
                    </div>
                    <div onClick={rightToLeft} className="rounded-full bg-white shadow-2xl w-[60px] h-[60px] hidden sm:block">
                    ...
                    <div onClick={leftToRight} className="rounded-full ms-8 shadow-2xl bg-white w-[60px] h-[60px] hidden sm:block">
                        <svg className="mt-5 ms-6" width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
